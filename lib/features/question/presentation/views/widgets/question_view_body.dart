...
class _QuestionViewBodyState extends State<QuestionViewBody> with SingleTickerProviderStateMixin{
        ...
        builder: (context, state)
        {
          return Padding(
            ...
            child: Column(
              ...
              children:
              [
                AppCubit.get(context).collections[CacheHelperKeys.collectionIndex!].questions[CacheHelperKeys.questionIndex!].isImage?
                    QuestionImageView(image: AppCubit.get(context).collections[CacheHelperKeys.collectionIndex!].questions[CacheHelperKeys.questionIndex!].text)
                :
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 30.0),
                  child: Text(
                    AppCubit.get(context).collections[CacheHelperKeys.collectionIndex!].questions[CacheHelperKeys.questionIndex!].text,
                    style:  TextStyle(
  ...
  void initAnimation()
  {
    animationController = AnimationController(
        vsync: this,
        duration: DelayManager.durationAnswerAppear
    );
    slidingAnimation = DelayManager.tweenAnswerAppearAnimation.animate(animationController);
