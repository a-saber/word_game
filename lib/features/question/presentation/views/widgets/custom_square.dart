...
class CustomSquare extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const TextStyle answerStyle = TextStyle(
        color: ColorsManager.fullAnswerTextColor, fontWeight: FontWeight.bold, fontSize: 15);
    TextStyle sampleStyle =
     const TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: ColorsManager.unChosenSampleTextColor);
    ...
    if (squareStatus == SquareStatus.answerFull)
    {
      return Container(
        ...
        decoration: BoxDecoration(
            color: ColorsManager.fullAnswerColor ,
    ...
    else if (squareStatus == SquareStatus.answerEmpty)
    {
      return Container(
        ...
        width: width,
        decoration: BoxDecoration(
            color: ColorsManager.emptyAnswerColor ,
            borderRadius: BorderRadius.circular(borderRadius)
        ),
      );
    }
    else if (squareStatus == SquareStatus.deleteButton)
    {
      return Container(
        ...
        width: sampleWidth,
        decoration: BoxDecoration(
            color: deleteTap ? ColorsManager.sampleBackgroundColor :ColorsManager.buttonBackgroundColor ,
            borderRadius: BorderRadius.circular(borderRadius)
        ),
        child: Center(
            child: Icon(
              deleteIcon,
              color: deleteTap ? ColorsManager.sampleBackgroundColor :ColorsManager.buttonIconColor ,
            )
        ),
      );
    }
    else if (squareStatus == SquareStatus.suggestButton)
    {
      return Container(
        ...
        width: sampleWidth,
        decoration: BoxDecoration(
            color: suggestTap ? ColorsManager.sampleBackgroundColor :ColorsManager.buttonBackgroundColor ,
            borderRadius: BorderRadius.circular(borderRadius)
        ),
        child: Center(
            child: Icon(
              suggestIcon ,
              color: suggestTap ? ColorsManager.sampleBackgroundColor :ColorsManager.buttonIconColor ,
            )
        ),
      );
    }
    ...
    else
    {
      return Container(
        ...
        width: sampleWidth,
        decoration: BoxDecoration(
            color: ColorsManager.unChosenSampleColor ,
            borderRadius: BorderRadius.circular(borderRadius)
        ),
        child: Center(
          child: Text(
