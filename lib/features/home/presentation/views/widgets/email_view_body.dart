...
import 'package:word_game/core/core_widget/default_textFromField.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppStates>(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextField(label: 'اسمك', controller: nameController, type: TextInputType.name),
                      const SizedBox(height: 20,),
                      CustomTextField(label: 'بريدك الإلكتروني', controller: emailController, type: TextInputType.emailAddress),
                      const SizedBox(height: 20,),
                      CustomTextField(label: 'أكتب اللغز', controller: queController, type: TextInputType.text, maxLines: 3,),
                      const SizedBox(height: 20,),
                      CustomTextField(label: 'جواب اللغز', controller: answerController, type: TextInputType.text),
        ...
        listener:  (context, state)
        {
          ...
          {
            makeToast(msg: "Added Successfully\nWe will contact you soon", state: ToastStates.SUCCESS);
            Navigator.pop(context);
          }
          if (state is AddQuestionErrorState)
          {
            makeToast(msg: "Internet Connection Error", state: ToastStates.ERRORCONNECT);
          }
        }
    );
  }
